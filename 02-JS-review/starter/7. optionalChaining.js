...
const summary = `${title}, a ${pages}-page long book, was wrotten by ${author} and published in ${getYear(
  publicationDate,
...
const pagesRange = pages > 1000 ? 'over a thousnad' : 'less than 1000';
pagesRange;
...
// If do not exist the whole front part will become undefined
