...
const updateBook = {
	...
	moviePublicactionDate: '2001-12-19',
...
const summary = `${title}, a ${pages}-page long book, was written by ${author} and published in ${getYear(
	publicationDate
)}. The book has ${hasMovieAdaptation ? '' : 'not'} bben adapted as movie`;
summary;

const pagesRange = pages > 1000 ? 'over a thousand' : 'less then 1000';
pagesRange;
console.log(`The book has ${pagesRange} panges`);
...
const count = book.reviews.librarything?.reviewsCount ?? "no daat";
count;
